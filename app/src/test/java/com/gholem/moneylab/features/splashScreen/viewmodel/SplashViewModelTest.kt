    ...
    fun `verify invocations when getCategories method is called and there are categories`() =
        runTest {
            ...
            val transactionCategory = mutableListOf(
                ExcomeCategoryModel("Others", R.drawable.ic_category_other),
                ExcomeCategoryModel("Transport", R.drawable.ic_category_transport),
                ExcomeCategoryModel("Food", R.drawable.ic_category_food),
                ExcomeCategoryModel("Sport", R.drawable.ic_category_sport)
            )
